            ...
            <div className="px-8 mx-auto max-w-page">
                <div className="mb-20">
                    <div className="mx-auto text-center md:max-w-xl lg:max-w-3xl">
                        ...
                        <p className="pb-2 mb-6 font-semibold text-blue-500 md:mb-12 md:pb-0">Skyline currently is only available for download through Github. Google Play support is planned.</p>
                    </div>
                    ...
                    <ul className="flex flex-wrap items-center justify-center my-12 font-roboto">
                        <div className="flex space-x-2 justify-center">
                            <CustomLink ripple href="https://github.com/skyline-emu/skyline/actions" className="flex px-5 py-3 text-sm font-medium leading-normal text-white uppercase transition duration-150 ease-in-out bg-green-500 rounded-lg shadow-md lg:px-8 hover:bg-green-600 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg align-center font-roboto">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" className="w-4 mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div id="carouselExampleCaptions" className="carousel slide relative" data-bs-ride="carousel">
                        ...
                        <div className="carousel-inner relative w-full overflow-hidden rounded-lg">
                            <div className="carousel-item active relative float-left w-full">
                                <img src="https://media.discordapp.net/attachments/546432817962156034/931251395837964348/Screenshot_20220114-011932103.jpg" className="block w-[1216px] h-[268.5px] md:h-[537px]" alt="..." />
                            ...
                            <div className="carousel-item relative float-left w-full">
                                <img src="https://cdn.discordapp.com/attachments/546432817962156034/967374268839125062/Screenshot_2022-04-23-16-09-28-90_fcf072b9e4efc4ce5ca3e36691a7c3c6.jpg?width=1216&height=537" className="block w-[1216px] h-[268.5px] md:h-[537px]" alt="..." />
                                <div className="carousel-caption hidden md:block absolute text-center bg-white dark:bg-zinc-900 dark:text-white text-black rounded-lg ">
                            ...
                            <div className="carousel-item relative float-left w-full">
                                <img src="https://cdn.discordapp.com/attachments/546432817962156034/967374971183718460/Screenshot_2022-04-23-16-12-32-47_fcf072b9e4efc4ce5ca3e36691a7c3c6.jpg" className="block w-[1216px] h-[268.5px] md:h-[537px]" alt="..." />
                                <div className="carousel-caption hidden md:block absolute text-center bg-white dark:bg-zinc-900 dark:text-white text-black rounded-lg">
